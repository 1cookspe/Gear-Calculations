...
%% CONSTANTS
life = 30*1000; % life in hours, Table 11-4
reliability = 0.99; % Assume 99% reliability of tapered rollers set
af = 2; % Assumed application factor = 2, Table 11-5
...
Fra = 1; % radial force on bearing A
Frb = 1; % radial force of bearing B
Fae = 0; % externally applied thrust load from another source --> force of drill
speed = 1;
